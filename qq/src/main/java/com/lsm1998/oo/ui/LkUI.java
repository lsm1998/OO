...
public class LkUI extends JFrame
{
    ...
    public LkUI()
    {
        ...
        icon = new ImageIcon(PathUtil.RESOURCES +"\\img\\按钮背景.png");
        icon1 = new ImageIcon(PathUtil.RESOURCES +"\\img\\log.png");
        icon2 = new ImageIcon(PathUtil.RESOURCES +"\\img\\1.jpg");
        icon3 = new ImageIcon(PathUtil.RESOURCES +"\\img\\3.png");
        ...
        JList<String> ja = new JList<>(strings);
