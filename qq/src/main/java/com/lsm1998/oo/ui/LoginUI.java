...
import com.lsm1998.oo.server.Client;
...
public class LoginUI extends JFrame implements MouseListener, ActionListener, ItemListener, MouseMotionListener
{
    ...
    public LoginUI()
    {
        ...
        JLabel code = new JLabel(new ImageIcon(PathUtil.RESOURCES +"\\img\\acount1.png"));
        code.setBounds(85, 170, 15, 15);
        bg.add(code);
        JLabel pass = new JLabel(new ImageIcon(PathUtil.RESOURCES +"\\img\\password.png"));
