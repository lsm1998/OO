package com.lsm1998.oo.ui;

import com.lsm1998.oo.bean.Sound;
import com.lsm1998.oo.domain.Friends;
import com.lsm1998.oo.domain.Group;
import com.lsm1998.oo.domain.Msg;
import com.lsm1998.oo.domain.User;
import com.lsm1998.oo.mapper.FriendsMapper;
import com.lsm1998.oo.mapper.GroupMapper;
import com.lsm1998.oo.mapper.MsgMapper;
import com.lsm1998.oo.mapper.UserMapper;
import com.lsm1998.oo.server.App;
import com.lsm1998.oo.util.Cmd;
import com.lsm1998.oo.util.PathUtil;
import com.lsm1998.oo.util.SendCmd;
import com.lsm1998.oo.util.SendMsg;
import com.lsm1998.oo.yuyin.Client;
...
public class MainUI extends JFrame implements MouseListener
{
    ...
    public MainUI(User myInfo, Socket socket)
    {
        ...
        this.setIconImage(new ImageIcon(PathUtil.RESOURCES + "\\img\\logo.png").getImage());
        this.setTitle("oo");
        bgImg = new JLabel(new ImageIcon(PathUtil.RESOURCES + "\\img\\MainBg.jpg"));
        ...
        JButton findBtn = new JButton(new ImageIcon("\\img\\CheckBut.png"));
        findBtn.setFocusPainted(false);
        findBtn.setBorderPainted(false);
        findBtn.setOpaque(false);
        findBtn.setContentAreaFilled(false);

        JButton btn1 = new JButton(new ImageIcon("\\img\\starBut.png"));
